...
module.exports.blueprints = {
    ...
    /****************************************************************************
     *                                                                           *
     * By default, you don't get socket notifications from the blueprints for    *
     * events that you yourself trigger. You can use the callback from the socket*
     * request methods instead (i.e. socket.post(url, data,  callback)). This    *
     * allow you to respond differently to actions that you triggered yourself,  *
     * rather than ones that were triggered by someone else. If you really want  *
     * to get your own socket notifications from the blueprints, you can set     *
     * mirror: true                                                              *
     *                                                                           *
     ****************************************************************************/
